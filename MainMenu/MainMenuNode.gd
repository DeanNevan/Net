...
func live_light():
	...
	TweenLightEnergy.interpolate_property($Light2D, "energy", $Light2D.energy, 1.1 * light_scale, 1.2, Tween.TRANS_LINEAR, Tween.EASE_OUT)
	TweenLightEnergy.start()
	yield(TweenLightEnergy, "tween_completed")
	TweenLightEnergy.stop_all()
	TweenLightEnergy.interpolate_property($Light2D, "energy", $Light2D.energy, 0.6 * light_scale, 0.6, Tween.TRANS_LINEAR, Tween.EASE_IN)
	TweenLightEnergy.start()
	yield(TweenLightEnergy, "tween_completed")
	pass
